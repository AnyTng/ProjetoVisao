...
int main(void) {
	...
	*/
	...
	{
		std::cout << "Ficheiro de vídeo aberto com sucesso!\n";
	}
	...
	while (key != 'q') {
		...
		*/
		...
		key = cv::waitKey(1000 / video.fps); // Espera 1 segundo (1000ms) dividido pelo número de frames por segundo do vídeo
	}
